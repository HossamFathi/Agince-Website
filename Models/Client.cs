...
namespace RoleProject.Models
{
    ...
    public class Client
    {
        ...
        public string password { get { return Password_Client; } set { Password_Client = value; } }
        [NotMapped]
        ...
        public int number_of_licience { get; set; }
        [Display(Name = "Date of Licience expiry")]

        public DateTime date_of_licience_expiry { get; set; }
